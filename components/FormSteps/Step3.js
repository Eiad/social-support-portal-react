    ...
    if (isArabic) {
      ...
      switch(fieldName) {
        case 'currentSituation':
          return `أنت تساعد شخصاً في كتابة طلب دعم اجتماعي حكومي. استناداً إلى وصفهم المختصر، اكتب تفسيراً مهنياً لوضعهم الحالي.

قواعد مهمة:
- اكتب في 4 أسطر بالضبط
- استخدم لغة رسمية مناسبة للطلبات الحكومية
- ركز على أهم التحديات والظروف

الوصف المختصر للمستخدم: "${currentText}"

اكتب بياناً مهنياً عن وضعهم الحالي يبرر حاجتهم للدعم الاجتماعي في 4 أسطر بالضبط.`;
...
- اكتب في 4 أسطر بالضبط
- استخدم لغة رسمية مناسبة للطلبات الحكومية
- ركز على الظروف المهنية والعقبات

الوصف المختصر للمستخدم: "${currentText}"

اكتب بياناً مهنياً عن ظروف عملهم يوضح وضعهم الوظيفي في 4 أسطر بالضبط.`;

        case 'reasonForApplying':
          return `أنت تساعد شخصاً في كتابة طلب دعم اجتماعي حكومي. استناداً إلى وصفهم المختصر، اكتب تفسيراً مهنياً لسبب حاجتهم للدعم.

قواعد مهمة:
- اكتب في 4 أسطر بالضبط
- استخدم لغة رسمية ومحترمة
- ركز على الاحتياجات والأسباب المبررة

الوصف المختصر للمستخدم: "${currentText}"

اكتب بياناً مهنياً يوضح سبب استحقاقهم للدعم الاجتماعي في 4 أسطر بالضبط.`;

        default:
          return `قم بتوسيع وتطوير هذا النص ليكون مهنياً ومناسباً لطلب دعم اجتماعي حكومي في 4 أسطر بالضبط: "${currentText}"`;
      }
    } else {
      // English prompts
      switch(fieldName) {

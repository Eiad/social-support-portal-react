...
// 0 -- Create axios instance with default configuration
...
// 1 -- Interceptors -- Modifies outgoing requests before they're sent
...
apiClient.interceptors.request.use(
  (config) => {
    ...
    if (token) {
      ...
      if (process.env.NODE_ENV === 'development') {
        console.log('uth header added:', token.substring(0, 20) + '...');
      }
    }
...
// 2 -- Processes all responses and errors from the server
